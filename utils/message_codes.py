...
# OBJECT LOST Validations Messages
LOST_OBJECTS_NOT_FOUND = 'LOST_OBJECTS_NOT_FOUND' #Lost_Objects not found
LOST_OBJECTS_SUCCESSFULLY_CREATED = 'LOST_OBJECTS_SUCCESSFULLY_CREATED' # Lost_Objects created successfully
LOST_OBJECTS_EXIST = 'LOST_OBJECTS_EXIST' #Lost_Objects already exist from database
LOST_OBJECTS_NAME_REQUIRED = 'LOST_OBJECTS_NAME_REQUIRED' # Requerid lost_objects name
LOST_OBJECTS_DESCRIPTION_REQUIRED = 'LOST_DESCRIPTION_NAME_REQUIRED' # Requerid lost_objects description
INVALID_EMAIL_DOMAIN = 'INVALID_EMAIL_DOMAIN' # Requerid valid email_domain
